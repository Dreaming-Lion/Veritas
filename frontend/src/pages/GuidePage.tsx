        ...
        >
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 items-stretch">
              <FeatureCard
                icon="src/assets/icon-trust-green.svg"
                title="신뢰성 있는 정보"
              >
              ...
              <FeatureCard
                icon="src/assets/icon-bookmark-green.svg"
                title="개인 맞춤 북마크"
              >
                관심 있는 기사를 북마크하고, <br />
                나만의 정치 뉴스 컬렉션을 <br />
              ...
              <FeatureCard
                icon="src/assets/icon-realtime-green.svg"
                title="실시간 업데이트"
              >
                새로운 기사가 실시간으로 <br />
                업데이트 되므로 언제든 <br />
              ...
              <div className="p-6 sm:p-8 lg:p-10">
                ...
                <dl className="mt-4 space-y-4">
                  <QA
                    ...
                    a={`Veritas는 한국의 정치 뉴스를 모아 제공하고, 사용자가 클릭한 기사와 반대되는 성향을 지닌 언론사의 뉴스 기사를 제공하는 정치 뉴스 플랫폼입니다.
객관적이고 신뢰할 수 있는 정보를 통해 시민들의 정치 참여를 돕고, 다양한 관점을 제공하여 건전한 정치 토론 문화를 만들어가는 것을 목표로 하고 있습니다.`}
                  />
                  <QA
                    q="뉴스는 어디에서 가져오나요?"
          ...
          >
            <Card glossy>
              <div className="p-6 sm:p-8 lg:p-10 text-center">
                ...
                <p className="mt-2 text-gray-600 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto">
...
function Legend({
  ...
  return (
    <div className="rounded-xl border border-green-100/60 bg-white/90 p-4">
      <span
        className={`inline-block rounded-2xl px-2.5 py-1 text-xs sm:text-sm font-semibold ${color}`}
      >
        {title}
      </span>
...
function QA({ q, a }: { q: string; a: string }) {
  return (
    <div className="rounded-xl border border-green-100/60 bg-white/90 p-4">
      <dt className="font-semibold text-slate-800 text-sm sm:text-base">
        Q. {q}
      </dt>
      <dd className="mt-1 text-gray-700 text-sm sm:text-base leading-relaxed whitespace-pre-line">
        A. {a}
      </dd>
    </div>
  );
