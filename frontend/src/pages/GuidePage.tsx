              ...
              <div className="p-6 sm:p-8 lg:p-10">
                ...
                <dl className="mt-4 space-y-4">
                  ...
                  <QA
                    ...
                    또한, 모든 뉴스는 출처가 명확히 표시되며, 각 뉴스 카드 하단의 '원문 보기'를 클릭하면 언론사의 전체 원문 내용을 확인할 수 있습니다."
                  />
                  <QA
                  ...
                  <QA
                    q="문의 답변은 어디서 확인하나요?"
                    a="Inquiry에서 등록한 문의는 회원가입 시 사용한 이메일로 답변이 전송되며,「Inquiry List」에서 답변 여부를 확인할 수 있습니다."
                  />
                </dl>
              </div>
            </Card>
