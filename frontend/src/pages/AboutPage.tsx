            ...
            <Card glossy>
              <div className="p-6 sm:p-8 lg:p-10 text-center">
                ...
                <p className="mt-3 text-gray-700 leading-relaxed">
                  ...
                  입니다.
                  <br /><br />
                  현대 사회에서 개인화를 위해 주로 사용되는 추천 알고리즘은 사용자의 만족도는 증가시키지만, 
                  ...
                  <br /><br />
                  일반적으로 미디어 리터러시 능력을 강화하는 방법에는 자신의 견해와 반대되는 의견을 가진
              ...
              <div className="p-6 sm:p-8 lg:p-10 grid gap-6 lg:grid-cols-2">
                ...
                <div>
                  ...
                  >
                    ...
                    <li>기사 요약 기능 제공</li>
                    <li>국내 15개 언론사의 RSS 피드를 활용해 반대 성향 언론사 기사 추천 기능 제공</li>
          ...
          >
            <Card>
              <div className="p-6 sm:p-8 lg:p-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 !whitespace-pre-line">
                  <TeamCard
                    name="오인화"
                    role="PM · 풀스택"
                    desc="추천 시스템 개발, \n 프론트/백엔드/AI 기능 개발 \n 전 과정 참여 및 리딩"
